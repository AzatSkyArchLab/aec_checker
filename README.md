...
- 🖱️ Мультивыбор по **Shift**, изоляция / скрытие / показать всё
- ✅ Проверки модели (расширяемые) — первая: геопривязка

## Управление 3D-сценой

| Действие | Как |
|---|---|
| Выбрать элемент | клик (в сцене или списке) |
| Добавить/убрать из выделения | **Shift** + клик |
| Показать только выделенное | кнопка «Изолировать» или **I** |
| Скрыть выделенное | кнопка «Скрыть» или **H** |
| Показать всё / снять выбор | кнопка «Показать всё» или **Esc** |
