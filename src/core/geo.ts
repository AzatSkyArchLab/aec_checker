...
export function computeFootprint(
  ...
  // «Уровень 0» — относительно самой модели: берём нижнюю точку общего bbox
  // и режем на +0.01 м выше (web-ifc отдаёт геометрию уже в метрах). Так план
  // строится всегда, где бы модель ни стояла по высоте.
  const sliceY = minY + 0.01;
